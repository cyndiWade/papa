            ...
            <div class="contentwrapper"><!--Content wrapper-->
                ...
                <div class="heading">
                    ...
                    <div class="search">
                        ...
                        <form id="searchform" action="?s=/User/addUser">
                            ...
                            <div class="box">
                                ...
                                <div class="content noPad">
                                    ...
                                    <table class="responsive table table-bordered">
                                        <thead>
                                          <tr>
                                            <th class="ttlnob03">　</th>
                                            <th></th>
                                          </tr>
                                        </thead>
                                        <tbody>
                                          <tr>
                                            <th class="ttl01">用户名：</th>
                                            <th><?php echo ($UserContent["account"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">员工名：</th>
                                            <th><?php echo ($UserContent["nickname"]); ?></th>
                                          </tr>
										  
										  <tr>
                                            <th class="ttl01">性别：</th>
                                            <th>
                                            	<?php if($UserContent['sex'] == 1): ?>男
												<?php else: ?>
												女<?php endif; ?>
											</th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">生日：</th>
                                            <th><?php echo ($UserContent["birthdays"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">年龄：</th>
                                            <th><?php echo ($UserContent["age"]); ?></th>
                                          </tr>
										  
										  <tr>
                                            <th class="ttl01">联系方式：</th>
                                            <th><?php echo ($UserContent["email"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">职位：</th>
                                            <th><?php echo ($UserContent["remark"]); ?></th>
                                          </tr>
										   <tr>
                                            <th class="ttl01">工资：</th>
                                            <th><?php echo ($UserContent["salary"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">在职状态：</th>
                                            <th>
                                            	<?php if($UserContent["status"] == 1 ): ?>在职										
												<?php else: ?> <span style="color:red;">离职</span><?php endif; ?>
                                            </th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">入职时间：</th>
                                            <th><?php echo ($UserContent["create_time"]); ?></th>
                                          </tr>
										   <tr>
                                            <th class="ttl01">离职时间：</th>
                                            <th><?php echo ($UserContent["update_time"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">最后登陆时间：</th>
                                            <th><?php echo ($UserContent["last_login_time"]); ?></th>
                                          </tr>	 
										   <tr>
                                            <th class="ttl01">最后登陆ip：</th>
                                            <th><?php echo ($UserContent["last_login_ip"]); ?></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">登陆次数：</th>
                                            <th><?php echo ($UserContent["login_count"]); ?></th>
                                          </tr>
										<tr>
                                            <td colspan="2"><a href="?s=/User/user" ><button class="btn">返回</button></a></td>
                                          </tr>
                                        </tbody>
                                    </table>
                                </div>

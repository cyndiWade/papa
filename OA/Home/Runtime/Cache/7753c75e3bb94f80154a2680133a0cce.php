                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>组列表<a href="?s=/User/groupEdit/add"><button class="btn">新建</button></a></span>
                                    </h4>
                                    ...
                                    <table class="responsive table table-bordered">
										...
										<td>
                                                <div class="controls center">
                                                	<a href="?s=/User/groupUser/<?php echo ($vo["id"]); ?>" title="查看" class="tip"><span class="icon12  icomoon-icon-user-3"></span></a>
                                                    <a href="?s=/User/groupEdit/update/<?php echo ($vo["id"]); ?>" title="编辑" class="tip"><span class="icon12 icomoon-icon-pencil"></span></a>
                                                    <a href="?s=/User/groupEdit/delete/<?php echo ($vo["id"]); ?>" title="删除" class="tip"><span class="icon12 icomoon-icon-remove" onclick="return confirm('确定要删除吗？') ? true : false"></span></a>
                                                </div>
                                            </td>

                        ...
                        <div class="span6">
                            ...
                            <div class="box">
                                ...
                                <div class="content noPad">
                                	<form method="post" action="?s=/User/updateUser">
                                		<input type="hidden" name="id" value="<?php echo ($userFind["id"]); ?>" />
										<input type="hidden" name="PREV_URL" value="<?php echo ($PREV_URL); ?>" />
										<input type="hidden" name="password_bak" value="<?php echo ($userFind["password"]); ?>" />
                                    <table class="responsive table table-bordered">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <th><?php echo ($userFind["account"]); ?></th>
                                          </tr>
                                          <tr>
                                          	<th class="ttl01">员工名：</th>
                                            <th><input type="text" name="nickname" value="<?php echo ($userFind["nickname"]); ?>" /></th>        
                                          </tr>
                                          <tr>
                                            <th class="ttl01">新密码：</th>
                                            <th><input type="password"  name="password" /></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">联系方式：</th>
                                            <th><input type="text"  name="email" value="<?php echo ($userFind["email"]); ?>" /></th>
                                          </tr>	  
										  <tr>
                                            <th class="ttl01">工资：</th>
                                            <th><input type="text"  name="salary" value="<?php echo ($userFind["salary"]); ?>" /></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">入职时间：</th>
                                            <th><input type="text"  name="create_time" id="datepicker" id="datepicker" value="<?php echo ($userFind["create_time"]); ?>" /></th>
                                          </tr>
                                          <tr>
                                            <th class="ttl01">职位描述：</th>
                                            <th><textarea name="remark"><?php echo ($userFind["remark"]); ?></textarea></th>
                                          </tr>
                                          <tr>
                                          	<td colspan="2"><button class="btn">确认</button></td>                                 
                                          </tr>
                                        </tbody>
                                    </table>
									</form>

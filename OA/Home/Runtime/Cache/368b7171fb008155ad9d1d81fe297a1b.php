                                ...
                                <div class="content">
									...
									<input type="hidden" name="PREV_URL" value="<?php echo ($PREV_URL); ?>" />
                                        ...
                                        <div class="form-row row-fluid">
                                            <div class="span12">
                                                <div class="leftBox">
                                                    <div class="searchBox"><input type="text" id="box1Filter" class="searchField" placeholder="搜索......"/><button id="box1Clear" type="button" class="btn"><span class="icon12  icomoon-icon-cancel-3"></span></button></div>
                                                    <!-- 左边的 -->
													<span style="color:red;">用户</span>
                                                    <select id="box1View" multiple="multiple" class="multiple nostyle" style="height:300px;">
                                                        <?php if(is_array($htmlUser)): $i = 0; $__LIST__ = $htmlUser;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                    <br/>
                                                ...
                                                <div class="dualBtn">
                                                    ...
                                                    <button id="to2" type="button" class="btn" ><!-- <span class="icon12 minia-icon-arrow-right-3"></span>-->右移</button>
                                                    <!-- <button id="allTo2" type="button" class="btn" ><span class="icon12 iconic-icon-last"></span></button> -->
                                                    <button id="to1" type="button" class="btn marginT5"><!--<span class="icon12 minia-icon-arrow-left-3"></span>-->左移</button>
                                                    <!-- <button id="allTo1" type="button"class="btn marginT5" ><span class="icon12 iconic-icon-first"></span></button>-->
                                                    
                                                </div>
                                                    
                                                <div class="rightBox">
                                                    <div class="searchBox"><input type="text" id="box2Filter" class="searchField" placeholder="搜索......" /><button id="box2Clear"  type="button" class="btn" ><span class="icon12  icomoon-icon-cancel-3"></span></button></div>
                                                	<!-- 第二个 -->
													<span style="color:red;"><?php echo ($roleName); ?>成员</span>
												    <select name="userid[]" id="box2View" multiple="multiple" class="multiple nostyle" style="height:300px;">
														<?php if(is_array($userYesList)): $i = 0; $__LIST__ = $userYesList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select><br/>

        ...
        <div class="navbar">
            <div class="navbar-inner">
              <div class="container-fluid">
                <a class="brand" href="dashboard.html">UCDChina.<span class="slogan">O.A</span></a>
                        ...
                        <div class="span6">
                            ...
                            <div class="box">
                                ...
                                <div class="content noPad">
									<form method="post" action="?s=/Project/save">
                                    <table class="responsive table table-bordered">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th class="ttl01">项目名：</th>
                                            <th><input type="textbox" name="pname" value="<?php echo ($list['pname']); ?>"/></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">开始时间：</th>
                                            <th><p><input type="textbox" id="datepicker" name="start_time" value="<?php echo ($list['start_time']); ?>"/></p></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">结束时间：</th>
                                            <th><p><input type="textbox" id="datepicker1" name="end_time" value="<?php echo ($list['end_time']); ?>"/></p></th>
                                          </tr>
										  <!--
										   <tr>
                                            <th class="ttl01">member：</th>
                                            <th><input type="textbox" name="member" value="<?php echo ($list['member']); ?>"/></th>
                                          </tr>
										  -->
										  <tr>
                                            <th class="ttl01">状态：</th>
                                            <td>
                                            	<div class="span8 controls">   
                                                        <select name="state" value="3">
															<?php if($list['state'] == 0): ?><option value="0" selected="selected">提案中</option>
															<?php else: ?>
															<option value="0">提案中</option><?php endif; ?>
															<?php if($list['state'] == 1): ?><option value="1" selected="selected">开发中</option>
															<?php else: ?>
															<option value="1">开发中</option><?php endif; ?>
															<?php if($list['state'] == 2): ?><option value="2" selected="selected">完成</option>
															<?php else: ?>
															<option value="2">完成</option><?php endif; ?>
															<?php if($list['state'] == 3): ?><option value="3" selected="selected">开发终止</option>
															<?php else: ?>
															<option value="3">开发终止</option><?php endif; ?>
                                                        </select>
                                                 </div> 
										 ...
										 <tr>
                                            <th class="ttl01">客户：</th>
                                            <th><input type="textbox" name="client" value="<?php echo ($list['client']); ?>"/></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">预算：</th>
                                            <th><input type="textbox" name="budget" value="<?php echo ($list['budget']); ?>"/></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">项目类型：</th>
                                            <th><input type="textbox" name="type" value="<?php echo ($list['type']); ?>"/></th>
                                          </tr>
										  <!-- 
										  <tr>
                                            <th class="ttl01">参与人员：</th>
                                            <th><textarea  name="person" ><?php echo ($list['person']); ?></textarea></th>
                                          </tr>
										  -->
										  <tr>
                                            <th class="ttl01">备注：</th>
                                            <th><textarea name="remarks" ><?php echo ($list['remarks']); ?></textarea></th>
                                          </tr>
										  <tr>
                                            <th class="ttl01">参考资料：</th>
                                            <th><textarea name="reference" ><?php echo ($list['reference']); ?></textarea></th>
                                          </tr>
											
										  <tr>
                                            <td colspan="2"><button class="btn btnsure">确认</button></td>
                                          </tr>
                                        </tbody>
                                    </table>
									</form>

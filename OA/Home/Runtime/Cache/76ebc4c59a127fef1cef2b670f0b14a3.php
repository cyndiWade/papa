                            ...
                            <div class="box">
                                ...
                                <div class="title">
                                    ...
                                    <h4>
                                        ...
                                        <span>节点管理[<a href="<?php echo ($PREV_URL); ?>">返回节点管理</a>]</span>
                                    </h4>
                                ...
                                <div class="content noPad">
                                    ...
                                    <table class="responsive table table-bordered">
                                        ...
                                        <tbody>
                                          <tr>
                                            <th class="ttl01">节点信息：</th>
                                            <th>节点名称：<input type="text" name="name" value="<?php echo ($nodeFind["name"]); ?>" /></th>
                                          </tr>
                                           <tr>
                                            <th></th>
                                            <th>节点标题：<input type="text" name="title" value="<?php echo ($nodeFind["title"]); ?>" /></th>
                                          </tr>
                                          <tr>
                                           <!--  <th colspan="2"><input class="button04" type="image" src="Home/Public/images/button05.gif" value="" onclick="javascript:window.location.href='tables04.html'"/></th> -->
										    <td colspan="2"><button class="btn">提交</button></td>
                                          </tr>
                                        </tbody>
                                    </table>
									</form>
